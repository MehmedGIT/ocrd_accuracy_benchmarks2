...
process ocrd_tesserocr_crop_1 {
    ...
    script:
        """
        ${params.docker_command} ocrd-tesserocr-crop -m ${mets_file} -I ${input_file_grp} -O ${output_file_grp}
        """
}
...
workflow {
    main:
        ...
        ocrd_tesserocr_crop_1(ocrd_cis_ocropy_binarize_0.out, "OCR-D-BIN", "OCR-D-CROP")
        ocrd_skimage_binarize_2(ocrd_tesserocr_crop_1.out, "OCR-D-CROP", "OCR-D-BIN2")
